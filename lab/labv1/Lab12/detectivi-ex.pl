...
% ----------------------------------------------------------------------------
% Mașini
minimum(L, X) :- findall(Y, (member(Y, L), findall(A, (member(A, L), A < Y), B), length(B, 0)), X).
secondMin(L, X) :- minimum(L, MinList), member(Min, MinList), member(Z, L), Z > Min,
                findall(Y, (member(Y, L), Y = Min, findall(A, (member(A, L), A = Min, A < Y), B), length(B, 0)), X).
...
arme_marca(Marca, ListaArme) :- setof(Arma, Nume ^ suspect(Nume:Marca:Arma), ListaArme).
...
suspect2(Nume:Marca:Arma) :- suspect1(Nume:Marca:Arma),
                             findall(Nume2, suspect1(Nume2:Marca:_), [_, _ | _]).
...
suspect3(Nume:Marca:Arma) :- suspect2(Nume:Marca:Arma),
                             findall(Nume2, suspect2(Nume2:_:Arma), [_, _ |_]).
...
suspect4(Nume:Marca:Arma) :- suspect3(Nume:Marca:Arma),
                             findall(Nume2, suspect3(Nume2:Marca:_), [_, _ |_]).
...
suspect5(Nume:Marca:Arma) :- suspect4(Nume:Marca:Arma),
                             findall(Nume2, suspect4(Nume2:_:Arma), [_]).
...
suspect6(Nume:Marca:Arma) :- suspect5(Nume:Marca:Arma),
                             findall(Nume2, suspect5(Nume2:Marca:_), [_]).
check12:- tests([
